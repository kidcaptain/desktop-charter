...
export default function Page({ params }: { params: IPrams }) {
    ...
    return (
        ...
        <div className=" py-4 flex justify-between items-start mb-2">
            <h1 className="text-lg text-gray-900"><Link className="hover:text-blue-600" href={"/dashboard/directeur/vehicules"}>Vehicules</Link>/<Link className="hover:text-blue-600" href={`/dashboard/directeur/vehicules/${params.vehiculeId}`}>n°{params.vehiculeId}</Link>/<Link className="hover:text-blue-600" href="">Fiche de suivie</Link></h1>
        </div>
