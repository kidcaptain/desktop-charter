        ...
        <div className="w-full p-10">
            ...
            <div className="mt-4 gap-4 grid items-start grid-cols-4 mx-auto ">
                ...
                <section className={`  shadow-xl rounded-sm ${(isOpenEditForm || isOpenAddForm) ? " col-span-3 " : "col-span-full"} `}>
                    <div className="bg-white shadow-2xl bordder rounded-sm">
                ...
                {isOpenEditForm ? (
                    <section className='bg-white shadow-2xl col-span-1'>
                        ...
                        <div className='p-4'>
                            <button onClick={() => { setIsOpenEditForm(false); setIsOpenAddForm(false) }} className="text-stone-500 w-full border font-bold text-xs text-center ">Fermer</button>
                        </div>
                    </section>
                ) : ""}
