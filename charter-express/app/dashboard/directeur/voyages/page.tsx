...
export default function Voyages() {
    ...
    const editerEvent = (val: any) => {
        switch (val.action) {
            case "edit":
                router.push(`/dashboard/directeur/voyages/${val.id}/editer`)
                break;
            case "view":
                    router.push(`/dashboard/directeur/voyages/${val.id}`)
                break;
            default:
                break;
        }
        ...
        <div className="p-10">
                ...
                <div className=" w-full">
                    <div className=" py-4 flex justify-between items-start mb-2">
                        ...
                        <Link href={"/dashboard/directeur/voyages/ajouter"} className="text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-sm text-xs px-5 py-2.5 text-center">
