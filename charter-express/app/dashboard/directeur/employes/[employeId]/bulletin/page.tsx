    ...
    return (
        <div className="p-10 ">
            <div className=" py-4 flex lowercase text-sm justify-between items-start mb-2">
                <h1 className=" text-gray-900"><Link className="hover:text-blue-600" href={"/dashboard/directeur/employes"}>Employés</Link> / <Link className="hover:text-blue-600" href="#"> Bulletin de paie</Link></h1>
            </div>
