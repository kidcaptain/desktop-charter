    ...
    return (
        <div className="p-10 ">
            <div className=" py-2 flex justify-between items-start">
                <h1 className="lowercase text-sm  text-gray-900"><Link className="hover:text-blue-600" href={"/dashboard/comptable/employees"}>Employés</Link> / <Link className="hover:text-blue-600" href="#">Informations personnelles</Link></h1>
            </div>
            <div className=" ">
                <h2 className="p-4 my-2 bg-white uppercase border-b">
                    Informations Personnelles
                </h2>
                <Link href={`/dashboard/comptable/employees/${params.employeId}/bulletin`} className=" hover:bg-blue-600 text-white text-sm border p-2 rounded-sm font-medium bg-blue-400">Générer fiche de paie</Link>
            </div>
